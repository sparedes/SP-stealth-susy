...
// Fri Aug  1 11:22:25 2014 by ROOT version 5.32/00
...
public :
   ...
   vector<float>   *vtxbsPtMod;
   vector<float>   *vtxbsSumPt2;
   ...
   vector<float>   *trkP_y;
   vector<float>   *trkP_z;
   vector<float>   *trkVtx_x;
   vector<float>   *trkVtx_y;
   vector<float>   *trkVtx_z;
   vector<float>   *trkd0;
   vector<float>   *trkd0Err;
   vector<float>   *trkdz;
   vector<float>   *trkdzErr;
   vector<float>   *trkPtErr;
   vector<int>     *trkQuality;
   Int_t           nGoodTrk;
   Int_t           IsTracksGood;
   Float_t         pdf[7];
   Float_t         pthat;
   ...
   Int_t           nLowPtJet;
   vector<float>   *jetLowPtEn;
   vector<float>   *jetLowPtPt;
   vector<float>   *jetLowPtEta;
   vector<float>   *jetLowPtPhi;
   vector<float>   *jetLowPtCharge;
   vector<float>   *jetLowPtEt;
   vector<float>   *jetLowPtRawPt;
   vector<float>   *jetLowPtRawEn;
   vector<float>   *jetLowPtArea;
   vector<int>     *jetLowPtPartonID;
   vector<float>   *jetLowPtGenJetEn;
   vector<float>   *jetLowPtGenJetPt;
   vector<float>   *jetLowPtGenJetEta;
   vector<float>   *jetLowPtGenJetPhi;
   vector<int>     *jetLowPtGenPartonID;
   vector<float>   *jetLowPtGenEn;
   vector<float>   *jetLowPtGenPt;
   vector<float>   *jetLowPtGenEta;
   vector<float>   *jetLowPtGenPhi;
   Int_t           nConv;
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/eos/uscms/store/user/ecarrera/ssusy/ggntuples/pythia8/T2_1000_150/ggtree_T2_1000_150.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/eos/uscms/store/user/ecarrera/ssusy/ggntuples/pythia8/T2_1000_150/ggtree_T2_1000_150.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/eos/uscms/store/user/ecarrera/ssusy/ggntuples/pythia8/T2_1000_150/ggtree_T2_1000_150.root:/ggNtuplizer");
